output "cloud_name" {
  ...
  value       = try(aiven_mysql.this[0].cloud_name, "")
}

output "components" {
  description = "Service component information objects."
  value       = try(aiven_mysql.this[0].components, "")
}
...
output "disk_space_cap" {
  ...
  value       = try(aiven_mysql.this[0].disk_space_cap, "")
}
...
output "disk_space_default" {
  ...
  value       = try(aiven_mysql.this[0].disk_space_default, "")
}
